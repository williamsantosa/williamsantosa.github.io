<script lang="ts">
	...
	import SectionHeaderSplit from '$lib/SectionHeaderSplit.svelte';	
</script>

<Landing textToCopy='williamwsantosa@gmail.com'/>

<SectionHeaderSplit title_left="Now" title_right="Building" />
